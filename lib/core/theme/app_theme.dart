...
class AppTheme {
  ...
  static ThemeData light() {
    final scheme = ColorScheme.fromSeed(
      ...
      tertiary: const Color(0xFF8A6B55),
      onTertiary: Colors.white,
      surface: _lightSurface,
      surfaceContainerLowest: const Color(0xFFFFFFFF),
      surfaceContainerLow: const Color(0xFFFFFAF3),
      surfaceContainer: _lightSurfaceMuted,
      surfaceContainerHigh: const Color(0xFFEAE0D5),
      surfaceContainerHighest: const Color(0xFFE2D6C9),
      onSurface: _lightText,
      onSurfaceVariant: const Color(0xFF655B53),
      outline: AppColors.softBorder,
      outlineVariant: const Color(0xFFE0D5CA),
      inverseSurface: const Color(0xFF302924),
      onInverseSurface: const Color(0xFFF8EFE7),
      inversePrimary: const Color(0xFFD9C0A7),
    );
